import numpy as np
# Backwards-compatibility shims for deprecated numpy aliases removed in
# recent NumPy releases. Some third-party packages (e.g. older
# tensorflowjs versions) still reference np.object and np.bool which
# were deprecated/removed. Define safe aliases if missing.
try:
    _ = np.object  # type: ignore
except Exception:
